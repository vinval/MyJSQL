(function(){
	...
	$.jsql = function(options) {
		...
		function JSQLloader (e) {
			if (e === true) {
				var image = set.loaderImage?set.loaderImage:loader();
				...
				$("body").append("<div id='JSQLloader'><table width='100%' height='100%' style='position:fixed; top:0; left:0; width:100%; height:100%; color:white; background-color: rgb(0,0,0); background-color: rgba(0,0,0,"+opacity+"); z-index:999999'><td align='center' valign='middle'><div style='width: "+width+"; height: "+height+"; background-repeat: no-repeat; background-image: url("+image+")'></div>"+text+"</td></table></div>");
			} else {
				$("#JSQLloader").remove();
			}
			function loader () {
